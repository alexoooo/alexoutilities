 ...
 * http://www.koders.com/java/fidAC38EC382F5096ECB5D21CF1A57BEB46C62E232E.aspx?s=cdef%3Atree
 *
 * The Permuter class provides an enumeration of all permutations of an array
 ...
 * </pre></blockquote>
 * To see all 2-permutations of these 4 names, create and use a Permuter enumeration:
 * <blockquote><pre>
 * Permuter c = new Permuter(children, 2);
                   ...
                   Iterable<T[]>
{
     ...
     * @param toPermute ...
     */
    public Permuter(T toPermute[])
    {
        this(toPermute, toPermute.length);
    }
     ...
     * @param toPermute ...
     */
    public Permuter(T toPermute[], int m)
    {
        assert toPermute.length >= m && m >= 0;

        this.n     = toPermute.length;
        this.m     = m;
        this.items = toPermute;
        scratchpad = Arrays.copyOf( items, m );
     ...
     * because the Permuter class implements Enumeration, which declares that the
