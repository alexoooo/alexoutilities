...
public class PersistentChars
{
    ...
    private static final String testOut =
            Dirs.get("test/out") + "/test.char";

    public static void main(String[] args)
    {
//        {
//    //        char test[] = {1000, 0, 20000, 60110, Character.MAX_VALUE};
//            char test[] = new char[ Integer.MAX_VALUE ];
//            for (int i = 0; i < test.length; i++) {
//                test[ i ] = (char) i;
//            }
//
//            PersistentChars.persist(test, testOut);
//        }
...
//    private static final int BUFFER_SIZE = 16384;
    ...
    public static void persist(
            char vals[], String fileName)
    {
        persist( vals, new File(fileName) );
    }
    public static void persist(
            char vals[], File toFile)
    {
        try
        {
    ...
    private static void doPersist(
            char vals[], File cacheFile) throws Exception
    {
